...
import { gainersQuery, losersQuery, pairsTimeTravelQuery } from "../queries";
import { getOneDayBlock, getTwoDayBlock } from "./blocks";
  ...
  await client.cache.writeQuery({
    ...
    data: {
      pairs: pairs.map((pair) => {
        ...
        const feesUSDGainedYesterday = volumeUSDGainedYesterday * 0.0025;
  ...
  await client.cache.writeQuery({
    ...
    data: {
      pairs: pairs.map((pair) => {
        ...
        const feesUSDLostYesterday = volumeUSDLostYesterday * 0.0025;
